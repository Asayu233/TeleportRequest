...
public final class TPCancelCommand {
    private static final List<String> aliases = List.of("tpx", "tpcancel");

    private TPCancelCommand() {}
            ...
            for (String alias : aliases)
                dispatcher.register(Commands
                    ...
                    .then(Commands
                        ...
                        .suggests(TPCancelCommand::suggests)
                        .executes(TPCancelCommand::execute)
                    )
                );
        }
    }
    ...
    private static int execute(@NotNull CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        RequestManager.INSTANCE.cancelRequest(sender, target);
        return 1;
    }
}
